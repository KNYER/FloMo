...
const char* ssid     = "PLDTHOMEFIBRdb3c0";
const char* password = "PLDTWIFIt4272";

// REPLACE with your Domain name and URL path or IP address with path
const char* serverName = "http://192.168.1.24/FLoMo/includes/dbwrite.php";
...
void loop() {
  ...
  centimeters = duration/58;
  distance = 70 - centimeters;
